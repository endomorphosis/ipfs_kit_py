...
replacement_method = '''def ipfs_name_resolve(self, name: str, recursive: bool = True, nocache: bool = False, timeout: int = None) -> Dict[str, Any]:
    """
...
if "def ipfs_name_resolve" in content:
    print("Method ipfs_name_resolve already exists, nothing to do")
    sys.exit(0)

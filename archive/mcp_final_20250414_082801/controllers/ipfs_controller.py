...
class IPFSController:
    ...
    async def swarm_disconnect(self, request: PeerAddressRequest) -> Dict[str, Any]:
        ...
        try:
            ...
            raise HTTPException(status_code=500, detail=f"Error disconnecting from peer: {str(e)}")
        ...
        try:
            ...
            if data.startswith(b"<!DOCTYPE html") or data.startswith(b"<html"):
                ...
                try:
                    ...
                    logger.debug(f"Content for CID {cid} looked like JSON but did not parse: {e}")
    ...
    async def list_files(
        ...
        try:
            ...
            raise HTTPException(status_code=500, detail=f"Error listing files in MFS: {str(e)}")
    ...
    async def make_directory(
        ...
        try:
            ...
            raise HTTPException(
                status_code=500, detail=f"Error creating directory in MFS: {str(e)}"
            )
    ...
    async def stat_file(
        ...
        try:
            ...
            raise HTTPException(
                status_code=500, detail=f"Error getting stats for MFS path: {str(e)}"
            )
    ...
    async def read_file(
        ...
        try:
            ...
            raise HTTPException(status_code=500, detail=f"Error reading file from MFS: {str(e)}")
    ...
    async def write_file(
        ...
        try:
            ...
            raise HTTPException(status_code=500, detail=f"Error writing to file in MFS: {str(e)}")
    ...
    async def remove_file(
        ...
        try:
            ...
            raise HTTPException(status_code=500, detail=f"Error removing from MFS: {str(e)}")

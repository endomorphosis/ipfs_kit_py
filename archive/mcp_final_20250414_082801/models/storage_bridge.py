...
class StorageBridgeModel:
    ...
    def _cleanup_temp_file(self, temp_path: str, operation: str, backend_name: str) -> None:
        """Remove a temporary file and log cleanup failures with context."""
        try:
            os.unlink(temp_path)
            ...
            logger.warning(
                "Failed to remove temporary file %s after %s on backend %s: %s",
                temp_path,
                operation,
                backend_name,
                e,
        ...
        try:
            ...
            if hasattr(backend_model, "get_content"):
                ...
                if dl_result and dl_result.get("success", False):
                    ...
                    self._cleanup_temp_file(temp_path, "get_content", backend_name)
        ...
        try:
            ...
            if hasattr(backend_model, "async_get_content"):
                ...
                if dl_result and dl_result.get("success", False):
                    ...
                    # Clean up temporary file
                    self._cleanup_temp_file(temp_path, "async_get_content", backend_name)
    ...
    def _store_content_in_backend(
        ...
        try:
            ...
            if hasattr(backend_model, "put_content"):
                ...
                # Clean up temporary file
                self._cleanup_temp_file(temp_path, "store_content", backend_name)
    ...
    async def _async_store_content_in_backend(
        ...
        try:
            ...
            if hasattr(backend_model, "async_put_content"):
                ...
                # Clean up temporary file
                self._cleanup_temp_file(temp_path, "async_store_content", backend_name)

...
and uses the correct server variable name and tool manager attribute.
"""
...
def backup_file(file_path):
    ...
    backup_path = f"{file_path}.bak.final"
    ...
    if 'async def handle_jsonrpc(' in content:
        ...
        if start_idx is not None:
            ...
            new_function = [
                ...
                "            tools = []",
                "            for tool_name, tool in server._tool_manager.tools.items():",
                "                tools.append({",
                "                    'name': tool_name,",

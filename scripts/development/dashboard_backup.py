...
'''
    ...
    def get_dashboard_html(self):
        """Get the simple dashboard HTML with 3-tab layout and working MCP configuration management."""
        return '''<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body>
    <div class="container">
        <div class="sidebar">
            <h1>📌 Pin Manager</h1>
            <p style="font-size: 0.875rem; color: #6b7280; margin-bottom: 20px;">IPFS Kit Dashboard</p>

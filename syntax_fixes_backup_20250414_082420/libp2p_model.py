...
result
    ...
    async def discover_peers(
        self, discovery_method: str = "all", limit: int = 10
        """
    ...
    async def dht_find_providers(
        self, cid: str, timeout: int = 30, limit: int = 20
        """
    ...
    async def pubsub_publish(
        self, topic: str, message: Union[str, bytes, Dict[str, Any]]
        """
    ...
    async def pubsub_subscribe(
        self, topic: str, handler_id: Optional[str] = None
        """
    ...
    async def register_message_handler(
        self, handler_id: str, protocol_id: str, description: Optional[str] = None
        """
...
metadata=self.metadata
    ...
    # DISABLED REDEFINITION
        self, topic: str, handler_function: Callable, handler_id: Optional[str] = None
        """

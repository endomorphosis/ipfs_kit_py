...
- **MCP Server Architecture**: Structured Model-Controller-Persistence design with clean separation of concerns
  - Server architecture has been fully consolidated in Q2 2025
...
See the [Containerization Guide](docs/containerization.md) for detailed instructions on Docker and Kubernetes deployments.
...
-   [Performance Profiling & Optimization](docs/performance_metrics.md)
...
For detailed implementation information, see the WebRTC streaming examples in the `examples/` directory.

...
class TestMultiaddressIntegration(unittest.TestCase):
    ...
    def test_multiaddr_parsing(self):
        ...
        test_cases = [
            ...
            ("/ip6/::1/tcp/5001", [
                {"protocol": "ip6", "value": "::1"},
                {"protocol": "tcp", "value": "5001"}
            ]),
            ...
            ("/unix/tmp/ipfs.sock", [
                {"protocol": "unix", "value": "/tmp/ipfs.sock"}
            ])
        ]
    ...
    def test_invalid_multiaddr_parsing(self):
        ...
        # Import the module under test
        from ipfs_kit_py.ipfs_multiformats import parse_multiaddr, MultiaddrParseError
    ...
    def test_multiaddr_string_conversion(self):
        ...
        # Import the module under test
        from ipfs_kit_py.ipfs_multiformats import parse_multiaddr, multiaddr_to_string
    ...
    def test_multiaddr_extraction(self):
        ...
        # Import the module under test
        from ipfs_kit_py.ipfs_multiformats import parse_multiaddr, get_protocol_value
        ...
        self.assertEqual(get_protocol_value(components, "p2p"), "QmYyQSo1c1Ym7orWxLYvCrM2EmxFTANf8wXmmE7DWjhx5N")
    ...
    def test_multiaddr_manipulation(self):
        ...
        from ipfs_kit_py.ipfs_multiformats import (
            parse_multiaddr, multiaddr_to_string,
            add_protocol, replace_protocol, remove_protocol
        )
        ...
        # Add p2p protocol
        new_components = add_protocol(components, "p2p", "QmYyQSo1c1Ym7orWxLYvCrM2EmxFTANf8wXmmE7DWjhx5N")
        new_addr = multiaddr_to_string(new_components)
        self.assertEqual(new_addr, "/ip4/127.0.0.1/tcp/4001/p2p/QmYyQSo1c1Ym7orWxLYvCrM2EmxFTANf8wXmmE7DWjhx5N")
        ...
        components = parse_multiaddr("/ip4/127.0.0.1/tcp/4001/p2p/QmYyQSo1c1Ym7orWxLYvCrM2EmxFTANf8wXmmE7DWjhx5N")
    ...
    def test_multiaddr_validation(self):
        ...
        # Import the module under test
        from ipfs_kit_py.ipfs_multiformats import is_valid_multiaddr, MultiaddrValidationError
    ...
    def test_listen_addrs_with_multiaddr(self, mock_run):
        ...
        mock_process = MagicMock()
        mock_process.returncode = 0
        mock_process.stdout = b'{"Key": "Addresses.Swarm", "Value": ["/ip4/0.0.0.0/tcp/4001", "/ip6/::/tcp/4001"]}'
        mock_run.return_value = mock_process

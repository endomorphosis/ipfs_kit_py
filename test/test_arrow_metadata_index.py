...
class TestArrowMetadataIndex(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.ipfs_client.dag_put = MagicMock(return_value={
            "success": True,
            "cid": "bafybeihpnxvlxjmwmm6guogdcnm5nmezfwvk3p5d4ixwqvq3chclgyuqoy"
        })
        
        self.ipfs_client.dag_get = MagicMock(return_value={
            "success": True,
            "value": {
                "partitions": {
                    "1": {
    ...
    def test_get_peer_partitions(self):
        ...
        self.index._get_peer_partitions_via_dag = MagicMock(return_value={
    ...
    def test_publish_index_dag(self):
        ...
        # Mock name_publish
        self.ipfs_client.name_publish = MagicMock(return_value={
            "success": True,
        ...
        self.assertTrue(result["success"])
        self.assertEqual(result["dag_cid"], "bafybeihpnxvlxjmwmm6guogdcnm5nmezfwvk3p5d4ixwqvq3chclgyuqoy")
        self.assertEqual(result["ipns_name"], "k51qzi5uqu5dkkciu33khkzbcmxtyhn376i1e83tya8kmwbag8fj36vrrt6v64")

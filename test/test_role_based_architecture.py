...
def master_node():
    ...
    instance.ipfs_kit_start = MagicMock(return_value={
        "ipfs": {"success": True},
        "ipfs_cluster_service": {"success": True}
    })
...
def worker_node():
    ...
    instance.ipfs_kit_start = MagicMock(return_value={
        "ipfs": {"success": True},
        "ipfs_cluster_follow": {"success": True}
    })
...
class TestRoleBasedArchitecture:
    ...
    def test_role_specific_startup(self, master_node, worker_node, leecher_node):
        ...
        assert "ipfs_cluster_service" not in leecher_result or leecher_result["ipfs_cluster_service"] is None
        assert "ipfs_cluster_follow" not in leecher_result or leecher_result["ipfs_cluster_follow"] is None
    ...
    def test_role_specific_shutdown(self, master_node, worker_node, leecher_node):
        ...
        master_node.ipfs_kit_stop = MagicMock(return_value={
            "ipfs": {"success": True},
            "ipfs_cluster_service": {"success": True}
        })
        
        worker_node.ipfs_kit_stop = MagicMock(return_value={
            "ipfs": {"success": True},
            "ipfs_cluster_follow": {"success": True}
        })
        
        leecher_node.ipfs_kit_stop = MagicMock(return_value={
            "ipfs": {"success": True},
...
class TestMasterRoleBehavior:
    ...
    def test_master_pin_operations(self, master_node):
        ...
        master_node.ipfs_add_pin = MagicMock(return_value={
            "success": True,
            "cid": "QmTestPin",
            "ipfs": {
                "success": True,
    ...
    def test_master_get_pinset(self, master_node):
        ...
        master_node.ipfs_get_pinset = MagicMock(return_value={
            "success": True,
            "ipfs": {
                "success": True,
...
class TestWorkerRoleBehavior:
    ...
    def test_worker_pin_operations(self, worker_node):
        ...
        # Mock the ipfs_add_pin method directly
        worker_node.ipfs_add_pin = MagicMock(return_value={
            "success": True,
            "cid": "QmTestPin",
            "ipfs": {
                "success": True,
    ...
    def test_worker_get_pinset(self, worker_node):
        ...
        # Mock the ipfs_get_pinset method directly
        worker_node.ipfs_get_pinset = MagicMock(return_value={
            "success": True,
            "ipfs": {
                "success": True,
                "pins": {"QmTest1": {"type": "recursive"}, "QmTest2": {"type": "recursive"}}
...
class TestLeecherRoleBehavior:
    ...
    def test_leecher_pin_operations(self, leecher_node):
        ...
        # Mock the ipfs_add_pin method directly
        leecher_node.ipfs_add_pin = MagicMock(return_value={
            "success": True,
            "cid": "QmTestPin",
            "ipfs": {
                "success": True,
    ...
    def test_leecher_get_pinset(self, leecher_node):
        ...
        # Mock the ipfs_get_pinset method directly
        leecher_node.ipfs_get_pinset = MagicMock(return_value={
            "success": True,
            "ipfs": {
                "success": True,
                "pins": {"QmTest1": {"type": "recursive"}, "QmTest2": {"type": "recursive"}}
...
class TestRoleSwitchingCapability:
    ...
    def test_role_switching(self):
        ...
        node.ipfs_kit_start = MagicMock(return_value={
            "ipfs": {"success": True}
        })
...
class TestClusterMembershipManagement:
    ...
    def test_master_peer_listing(self, master_node):
        ...
        master_node.ipfs_cluster_peers_ls = MagicMock(return_value={
            "success": True,
            "peers": [
                {
                    "id": "QmMasterNodeID",
    ...
    def test_worker_follower_info(self, worker_node):
        ...
        worker_node.ipfs_follow_info = MagicMock(return_value={
            "success": True,
            "cluster_name": "test-cluster",
...
class TestClusterDistributedState:
    ...
    def test_worker_sync_state(self, worker_node):
        ...
        worker_node.ipfs_follow_sync = MagicMock(return_value={
            "success": True,
            "synced": 10,
            "pins_added": 5,
            "pins_removed": 2

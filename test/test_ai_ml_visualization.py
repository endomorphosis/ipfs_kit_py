...
class TestAIMLVisualization(unittest.TestCase):
    ...
    def setUp(self):
        ...
        for epoch in range(5):
            ...
            self.metrics.record_metric(f"{model_id}/epoch/{epoch}/learning_rate", 0.01 * (0.9 ** epoch))
        ...
        for worker_id in range(3):
            for i in range(10):
                self.metrics.record_metric(f"workers/worker-{worker_id}/utilization", 0.5 + i * 0.05)

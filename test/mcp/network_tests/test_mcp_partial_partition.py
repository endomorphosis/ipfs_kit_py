...
which provides comprehensive network testing capabilities:
    ...
    python network_simulator.py --scenario partial_partition
...
def main():
    """Run the partial partition test using the new network_simulator."""
    # Show deprecation warning
    warnings.warn(
        "run_mcp_partial_partition_test.py is deprecated and will be removed in a future version. "

...
The network simulator supports multiple scenarios including intermittent connectivity tests,
...
def main():
    """Run the intermittent connectivity test using the new network_simulator."""
    # Show deprecation warning
    warnings.warn(
        "run_mcp_intermittent_connectivity_test.py is deprecated and will be removed in a future version. "
        "Please use network_simulator.py instead.",
        DeprecationWarning, stacklevel=2
    )

    print("Running intermittent connectivity test using the new network_simulator module...")
    ...
    # Build command for intermittent scenario
    cmd = [
        sys.executable,

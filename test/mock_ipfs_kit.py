...
class MockIPFSKit:
    ...
    def __init__(self, role="leecher", resources=None, metadata=None):
        ...
        self.ipfs_swarm_peers = MagicMock(return_value={"success": True, "peers": ["/ip4/1.2.3.4/tcp/4001/p2p/QmPeer"]})
        ...
        self.cluster_status = MagicMock(return_value={"success": True, "cid": "QmTest", "status": "pinned"})
        self.cluster_status_all = MagicMock(return_value={"success": True, "pins": [{"cid": "QmTest", "status": "pinned"}]})
        self.cluster_peers = MagicMock(return_value={"success": True, "peers": [{"id": "QmPeer", "addresses": ["/ip4/1.2.3.4/tcp/9096"]}]})
        
        # AI/ML methods
        self.ai_model_add = MagicMock(return_value={"success": True, "model_id": "model1", "cid": "QmTest"})
        self.ai_model_get = MagicMock(return_value={"success": True, "model": MagicMock()})
        self.ai_dataset_add = MagicMock(return_value={"success": True, "dataset_id": "dataset1", "cid": "QmTest"})

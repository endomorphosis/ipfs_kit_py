...
class TestStateReplication:
    ...
    def test_state_initialization(self, cluster_state_setup):
        ...
        master.state_crdt.initialize = MagicMock(return_value={
            "success": True,
    ...
    def test_state_synchronization(self, cluster_state_setup):
        ...
        master.state_crdt.get_state_update = MagicMock(return_value={
            "success": True,
            "sequence_number": 42,
            "updates": [
        ...
        worker.state_crdt_replica.apply_updates = MagicMock(return_value={
            "success": True,
            "applied_count": 2,
...
class TestPartialStateUpdates:
    ...
    def test_create_partial_update(self, cluster_state_setup):
        ...
        master.state_crdt.create_patch = MagicMock(return_value={
            "success": True,
            "patch": expected_diff,
            "from_version": 1,
            "to_version": 2
    ...
    def test_apply_partial_update(self, cluster_state_setup):
        ...
        worker.state_crdt_replica.apply_patch = MagicMock(return_value={
            "success": True,
...
class TestConflictResolution:
    ...
    def test_detect_conflicts(self, cluster_state_setup):
        ...
        master.state_crdt.detect_conflicts = MagicMock(return_value={
            "has_conflict": True,
            "conflicts": [
                {
                    "path": "/pins/1/name",
    ...
    def test_last_write_wins_resolution(self, cluster_state_setup):
        ...
        # Mock LWW resolution
        master.state_crdt.resolve_conflict_lww = MagicMock(return_value={
            "resolved": True,
            "winner": {
                "path": "/pins/1/name",
                "value": "new-name-2",
    ...
    def test_custom_merge_resolution(self, cluster_state_setup):
        ...
        master.state_crdt.resolve_conflict_custom = MagicMock(return_value={
            "resolved": True,
            "merged_value": {
                "path": "/pins/1/allocations",
...
class TestGossipBasedSynchronization:
    ...
    def test_gossip_protocol(self, cluster_state_setup):
        ...
        # Mock gossip setup
        master.setup_gossip_protocol = MagicMock(return_value={
            "success": True,
        ...
        master.publish_state_update = MagicMock(return_value={
            "success": True,

...
class TestARCache(unittest.TestCase):
    ...
    def test_eviction(self):
        ...
        self.assertLess(self.cache.current_size, self.cache.maxsize + 100)  # Allow for slight overage during eviction
...
class TestDiskCache(unittest.TestCase):
    ...
    def test_eviction(self):
        ...
        self.assertLess(self.cache.current_size, self.cache.size_limit + 100)  # Allow for slight overage during eviction
    ...
    def test_metadata(self):
        ...
        self.assertEqual(
            self.cache.index["key_with_metadata"]["metadata"]["mimetype"], 
            "text/plain"
        )
...
class TestTieredCacheManager(unittest.TestCase):
    ...
    def test_tiered_eviction(self):
        ...
        self.assertLess(self.cache.memory_cache.current_size, self.config['memory_cache_size'] + 100)

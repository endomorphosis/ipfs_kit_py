...
class TestHighLevelAPIJournalMonitoring(unittest.TestCase):
    ...
    def test_generate_journal_dashboard(self):
        ...
        self.mock_visualization.create_dashboard.return_value = {
        ...
        def mock_generate_journal_dashboard(timeframe_hours=24, output_dir=None):
            ...
            dashboard = self.api._journal_visualization.create_dashboard(
            ...
            return {
                ...
                "plots": [
                    dashboard["entry_types"],
                    dashboard["entry_statuses"],
                    dashboard["journal_growth"],
                    dashboard["html_report"]
                ]
            }

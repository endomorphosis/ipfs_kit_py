...
class TestCLIBasic(unittest.TestCase):
    ...
    def test_cli_add_command(self):
        ...
        try:
            ...
            with patch("ipfs_kit_py.cli.parse_args", return_value=args), patch(
                "ipfs_kit_py.cli.IPFSSimpleAPI", return_value=mock_instance
    ...
    def test_cli_version_command(self):
        ...
        with patch("ipfs_kit_py.cli.parse_args", return_value=args), patch(
            "ipfs_kit_py.cli.IPFSSimpleAPI", return_value=mock_instance
        ), patch("pkg_resources.get_distribution") as mock_dist, patch(
            "sys.stdout", new=captured_output
        ):

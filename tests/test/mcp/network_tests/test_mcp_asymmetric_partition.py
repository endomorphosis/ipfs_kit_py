...
which provides comprehensive network testing capabilities:
    ...
    python network_simulator.py --scenario asymmetric_partition
...
def main():
    """Run the asymmetric partition test using the new network_simulator."""
    # Show deprecation warning
    warnings.warn(
        "run_mcp_asymmetric_partition_test.py is deprecated and will be removed in a future version. "

...
class Phase2Tester:
    ...
    def setup_test_environment(self) -> bool:
        ...
        try:
            ...
            from mcp.ipfs_kit.core.tool_registry import registry
            from mcp.ipfs_kit.core.service_manager import ipfs_manager
            from mcp.ipfs_kit.core.error_handler import error_handler

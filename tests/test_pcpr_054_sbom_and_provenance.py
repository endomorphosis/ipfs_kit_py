"""PCPR-054: produce Kit SBOMs and provenance."""
...
def test_closed_vocabularies_match_pcpr_054_requirements() -> None:
    ...
    assert INTERFACE == "KitSbomAndProvenance@1"
    assert SCHEMA == "ipfs_kit_py/assurance/sbom-and-provenance@1"
    ...
    assert document["direct_package_count"] == 22
...
def test_committed_files_match_generator() -> None:
    ...
    assert 'interface = "KitSbomAndProvenance@1"' in pyproject

...
class TestMCPReplicationPolicy(unittest.TestCase):
    ...
    @pytest.mark.anyio
    async def test_mcp_replication_api_endpoint(self):
        ...
        # Call the replication status endpoint
        response = await ipfs_controller.get_replication_status(mock_request)

...
from fastapi import APIRouter, Depends, HTTPException, Request, Body, Form, Header, Query
...
def create_auth_router(api_prefix: str) -> APIRouter:
    ...
    async def list_users(
        ...
        users_result = auth_manager.list_users(
            page=page,
            page_size=page_size,
            role_filter=role
        )
    ...
    async def create_role(
        ...
        try:
            ...
            role_info = auth_manager.create_role(
                name,
                description,
                permissions_list
            )
    ...
    async def update_role_permissions(
        ...
        try:
            ...
            result = auth_manager.update_role_permissions(
                role_id,
                permissions_list
            )
...
def update_auth_status(storage_backends: Dict[str, Any]) -> None:
    ...
    storage_backends["auth"] = {
        ...
        } if AUTH_MANAGER_AVAILABLE and auth_manager is not None else {}
    }

...
from enhanced_storacha_storage import EnhancedStorachaStorage, STORACHA_LIBRARIES_AVAILABLE
...
def update_storacha_status(storage_backends: Dict[str, Any]) -> None:
    ...
    storage_backends["storacha"] = {
        ...
        "endpoint": status.get("endpoint", status.get("working_endpoint", status.get("fallback_endpoint", "")))
    }
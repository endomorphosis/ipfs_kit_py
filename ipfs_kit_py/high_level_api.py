...
"""
    ...
    def get_filesystem(
        ...
        **kwargs
        ...
        # Check if we have fsspec available first
        try:
            import fsspec
        ...
        # If we don't have fsspec or IPFSFileSystem, return a mock implementation
        if not FSSPEC_AVAILABLE or not HAVE_FSSPEC or not HAVE_IPFSFS:
            # Return a mock filesystem for testing purposes
        ...
        try:
            ...
            return self._filesystem
        except Exception as e: # Catch all errors during initialization
            logger.error(f"Failed to initialize IPFSFileSystem: {e}")
            # Return the mock implementation as fallback
            return MockIPFSFileSystem(**kwargs)

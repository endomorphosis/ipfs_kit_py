...
def extend_ipfs_kit_class(ipfs_kit_cls):
    ...
    def enhanced_get_filesystem(self, socket_path=None, cache_config=None, use_mmap=True, 
                               enable_metrics=True, gateway_urls=None, gateway_only=False, 
                               use_gateway_fallback=False, use_libp2p=True):
        ...
        fs = original_get_filesystem(self, socket_path, cache_config, use_mmap, 
                                    enable_metrics, gateway_urls, gateway_only, 

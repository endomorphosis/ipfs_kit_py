...
class FilecoinModel(BaseStorageModel):
    ...
    def get_block(self, block_cid: str) -> Dict[str, Any]:
        ...
        try:
            ...
            if self.kit:
                ...
                block_result = self.kit.chain_get_block(block_cid)
        ...
        try:
            ...
            if self.kit:
                ...
                if limit is not None:
                    ...
                    search_result = self.kit._call_api("Filecoin.StateSearchMsgLimited", [cid_param, limit])
                else:
    ...
    # State API methods
    def get_actor(self, address: str, tipset_key: Optional[List[Dict[str, str]]] = None) -> Dict[str, Any]:
    ...
    def state_list_miners(self, tipset_key: Optional[List[Dict[str, str]]] = None) -> Dict[str, Any]:
        """List all miners in the network.
    ...
    def state_miner_power(self, miner_address: str, tipset_key: Optional[List[Dict[str, str]]] = None) -> Dict[str, Any]:
    ...
    # Multisig methods
    def create_multisig(self, required_signers: int, signer_addresses: List[str], 
                       unlock_duration: int, initial_balance: str, sender_address: str) -> Dict[str, Any]:
        ...
        try:
            ...
            if self.kit:
                multisig_result = self.kit.multisig_create(
                    required_signers, signer_addresses, unlock_duration, initial_balance, sender_address
                )
    ...
    def get_multisig_balance(self, multisig_address: str) -> Dict[str, Any]:
        ...
        try:
            ...
            if self.kit:
                balance_result = self.kit._call_api("Filecoin.MsigGetAvailableBalance", [multisig_address, []])
    ...
    def list_pending_multisig_transactions(self, multisig_address: str) -> Dict[str, Any]:
        ...
        try:
            ...
            if self.kit:
                pending_result = self.kit._call_api("Filecoin.MsigGetPending", [multisig_address, []])
    ...
    def propose_multisig_transaction(self, multisig_address: str, recipient_address: str, 
                                   value: str, proposer_address: str, 
                                   method: int = 0, params: bytes = None) -> Dict[str, Any]:
        ...
        try:
            ...
            if self.kit:
                propose_result = self.kit._call_api(
                    ...
                    [multisig_address, recipient_address, value, proposer_address, method, params_encoded]
                )
    ...
    def approve_multisig_transaction(self, multisig_address: str, transaction_id: int, 
                                   approver_address: str) -> Dict[str, Any]:
    ...
    def cancel_multisig_transaction(self, multisig_address: str, transaction_id: int, 
                                  canceller_address: str) -> Dict[str, Any]:
        ...
        try:
            ...
            if self.kit:
                ...
                cancel_result = self.kit._call_api(
                    "Filecoin.MsigCancel", 
                    [multisig_address, transaction_id, to_address, value, canceller_address, method, params]
                )
    ...
    def create_payment_channel(self, from_address: str, to_address: str, amount: str) -> Dict[str, Any]:
        ...
        try:
            ...
            if self.kit:
                channel_result = self.kit._call_api("Filecoin.PaychGet", [from_address, to_address, amount])
    ...
    def create_payment_channel_voucher(self, channel_address: str, amount: str, lane: int = 0) -> Dict[str, Any]:
        ...
        try:
            ...
            if self.kit:
                voucher_result = self.kit._call_api("Filecoin.PaychVoucherCreate", [channel_address, amount, lane])
    ...
    def check_payment_channel_voucher(self, channel_address: str, voucher: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            if self.kit:
                check_result = self.kit._call_api("Filecoin.PaychVoucherCheckValid", [channel_address, voucher])
    ...
    def submit_payment_channel_voucher(self, channel_address: str, voucher: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            if self.kit:
                ...
                submit_result = self.kit._call_api("Filecoin.PaychVoucherSubmit", 
    ...
    def gas_estimate_message_gas(self, message: Dict[str, Any], tipset_key: Optional[List[Dict[str, str]]] = None) -> Dict[str, Any]:

...
class FilecoinModelAnyIO(FilecoinModel):
        ...
        try:
            ...
            if self.kit:
                deals_result = await anyio.to_thread.run_sync(
                    lambda: self.kit.client_list_deals()
                )
    ...
    def start_deal(self, data_cid: str, miner: str, price: str, duration: int, wallet: Optional[str] = None,
        ...
        return super().start_deal(data_cid, miner, price, duration, wallet, verified, fast_retrieval)
    ...
    def ipfs_to_filecoin(self, cid: str, miner: str, price: str, duration: int, wallet: Optional[str] = None,
        ...
        return super().ipfs_to_filecoin(cid, miner, price, duration, wallet, verified, fast_retrieval, pin)
    ...
    async def filecoin_to_ipfs_async(self, data_cid: str, pin: bool = True) -> Dict[str, Any]:
        ...
        try:
            ...
            try:
                ...
                # Get file size for statistics
                file_size = await anyio.to_thread.run_sync(
                    lambda: self._get_file_size(temp_path)
                )

...
class S3CredentialsRequest(BaseModel):
    ...
    endpoint_url: Optional[str] = Field(None, description="Custom endpoint URL for S3-compatible services")
...
class S3Controller:
    ...
    async def handle_upload_request(self, request: S3UploadRequest = None, file: UploadFile = File(None), 

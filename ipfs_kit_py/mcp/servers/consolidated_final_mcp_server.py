...
- Fixed JSON-RPC implementation using jsonrpcserver library
...
class MCPServer:
    ...
    def ipfs_cat(self, hash: str) -> Dict:
        """Retrieve content from IPFS"""
        return self.ipfs.cat(hash)
    
    def ipfs_pin_add(self, hash: str) -> Dict:
        """Pin content to local IPFS node"""
        return self.ipfs.pin_add(hash)
    
    def ipfs_pin_ls(self) -> Dict:
        """List pinned content"""
        return self.ipfs.pin_ls()
    
    def ipfs_pin_rm(self, hash: str) -> Dict:
        """Unpin content from local IPFS node"""
        return self.ipfs.pin_rm(hash)

"""
Auto-generated bridge module from mcp_server.server_anyio to mcp.server_anyio.
...
try:
    ...
    for name in __all__:
        try:
            ...
            logger.debug(f"Imported {name} from ipfs_kit_py.mcp_server.server_anyio")
        except AttributeError:
            logger.warning(f"Failed to import {name} from ipfs_kit_py.mcp_server.server_anyio")
    
    logger.debug(f"Successfully imported from ipfs_kit_py.mcp_server.server_anyio")
except ImportError as e:
    logger.error(f"Failed to import from ipfs_kit_py.mcp_server.server_anyio: {e}")

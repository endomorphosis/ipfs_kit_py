...
class BaseStorageModel:
    ...
    def _initialize_stats(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "latency": {
                ...
                "download": {"min": None, "max": None, "avg": None, "count": 0, "sum": 0},
                "list": {"min": None, "max": None, "avg": None, "count": 0, "sum": 0},
                "delete": {"min": None, "max": None, "avg": None, "count": 0, "sum": 0},
                "transfer": {"min": None, "max": None, "avg": None, "count": 0, "sum": 0},
            },
    ...
    async def _handle_operation_result_async(self, 
                                          result: Dict[str, Any], 
                                          operation: str, 
                                          start_time: float, 
                                          bytes_count: Optional[int] = None) -> Dict[str, Any]:
        ...
        processed_result = self._handle_operation_result(
            result, operation, start_time, bytes_count
        )
    ...
    async def _cache_put_async(self, key: str, value: Any, metadata: Optional[Dict[str, Any]] = None) -> bool:
        """
    ...
    async def _with_retry_async(self, 

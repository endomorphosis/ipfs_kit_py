...
class MigrationPolicy(BaseModel):
    ...
    schedule: Optional[str] = Field(None, description="Cron-style schedule for recurring migrations")
...
class BackendMigrationCapabilities(BaseModel):
    ...
    supports_bulk_operations: bool = Field(False, description="Whether backend supports bulk operations")

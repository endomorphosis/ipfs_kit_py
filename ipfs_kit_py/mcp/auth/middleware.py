...
class AuthMiddleware(BaseHTTPMiddleware):
    ...
    def __init__(self, app: FastAPI, auth_service: AuthenticationService,
                 exclude_paths: List[str] = None, require_auth: bool = False):
        """
    ...
    def register_route_permission(self, path: str, method: str, 
    ...
    def register_route_role(self, path: str, method: str, 
    ...
    async def dispatch(self, request: Request, call_next: Callable) -> Response:
        ...
        if token:
            if token_type == "api_key":
                ...
                if valid and api_key_obj:
                    ...
                    jwt_token = await self.auth_service.create_access_token_from_api_key(api_key_obj)
        ...
        if (self.require_auth or requires_permission or requires_role) and not auth_context["authenticated"]:
        ...
        if requires_permission:
            ...
            if required_permission not in auth_context["permissions"]:
                ...
                if len(permission_parts) > 1:
                    ...
                    if wildcard_perm not in auth_context["permissions"] and admin_perm not in auth_context["permissions"]:
                        return JSONResponse(

...
class S3Backend(BackendStorage):
    ...
    def __init__(self, resources: Dict[str, Any], metadata: Dict[str, Any]):
        ...
        self.aws_secret_key = resources.get('aws_secret_key') or os.environ.get('AWS_SECRET_ACCESS_KEY')
    ...
    def _init_local_cache(self):
        ...
        self.cache_size_limit = int(self.resources.get('cache_size_limit', 1024 * 1024 * 100))  # Default: 100MB
    ...
    def _clean_cache(self):
        ...
        try:
            ...
            freed_space = 0
            target_free = max(self.cache_size_limit // 2, self.chunk_size * 2)
        ...
        try:
            ...
            return {
                ...
                "details": {
                    "bucket": bucket,
                    "key": identifier,
                    "full_response": {k: str(v) for k, v in response.items() if k != 'ResponseMetadata'}
                }
            }

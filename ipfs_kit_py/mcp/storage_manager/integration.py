...
class StorageManagerIntegration:
    ...
    def _init_components(self):
        ...
        try:
            ...
            from ipfs_kit_py.mcp.storage_manager.notifications import (
                NotificationManager, StorageNotificationService, WebSocketStorageNotifier
            )
    ...
    def _register_routes(self):
        ...
        if not hasattr(self.server, "register_handler") or not callable(self.server.register_handler):
            logger.warning("Server does not have register_handler method, skipping route registration")
            return
    ...
    async def _handle_rest_api(self, request):
        ...
        try:
            ...
            return self.server.create_response(500, {
                "success": False,

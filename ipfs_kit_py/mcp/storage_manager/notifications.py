...
class StorageNotification:
    ...
    @classmethod
    def from_dict(cls, data: Dict[str, Any]) -> 'StorageNotification':
...
class NotificationSubscription:
    ...
    def matches(self, notification: StorageNotification) -> bool:
        """
    ...
    async def deliver(self, notification: StorageNotification) -> bool:
        """
...
class NotificationManager:
    ...
    def get_client_subscriptions(self, client_id: str) -> List[NotificationSubscription]:
        """
    ...
    async def _deliver_notification(self, notification: StorageNotification) -> None:
        """
        ...
        for subscription in matching_subscriptions:
            try:
                ...
                logger.error(f"Error delivering notification to subscription {subscription.id}: {e}")
...
class WebSocketStorageNotifier:
    ...
    async def on_connect(self, websocket, client_id: Optional[str] = None) -> str:
        """
    ...
    async def on_message(self, websocket, client_id: str, message: Dict[str, Any]) -> None:
        """
    ...
    async def _handle_subscribe(self, websocket, client_id: str, message: Dict[str, Any]) -> None:
        """
        ...
        try:
            ...
            async def notification_callback(notification: StorageNotification) -> None:
                try:
                    await websocket.send_json({
                        "type": "notification",
            ...
            await websocket.send_json({
                ...
                "notification_types": [t.value for t in notification_types] if notification_types else None,
                "subjects": subjects,
    ...
    async def _handle_unsubscribe(self, websocket, client_id: str, message: Dict[str, Any]) -> None:
        """
    ...
    async def _handle_get_history(self, websocket, client_id: str, message: Dict[str, Any]) -> None:
        """

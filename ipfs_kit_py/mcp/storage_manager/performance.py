...
class ConnectionPool:
    ...
    def __init__(self, max_connections: int = 10, connection_ttl: int = 300):
        """
    ...
    def get_connection(self, backend_type: Union[StorageBackendType, str], conn_params: Dict[str, Any] = None) -> Any:
        """
    ...
    def _create_connection(self, backend_type: Union[StorageBackendType, str], conn_params: Dict[str, Any]) -> Any:
        """
            ...
            try:
                ...
                with self.lock:
                    ...
                    for backend_key, pool in list(self.pools.items()):
                        ...
                        logger.debug(f"Cleaned up {len(expired)} idle connections for {backend_key}")
...
class LoadBalancer:
    ...
    def select_backend(
        ...
        scores = {}
        for backend in available_backends:
            scores[backend] = self._calculate_backend_score(
                backend, 
                operation, 
                content_metadata
            )

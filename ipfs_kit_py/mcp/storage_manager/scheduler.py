...
from .migration import MigrationController, MigrationPolicy, MigrationPriorityLevel
    ...
    def _parse_schedule(self):
        ...
        if self.schedule_type == ScheduleType.CRON:
            ...
            try:
                ...
                dt_next = dt_now.replace(day=min(day, 28), hour=hour, minute=minute, second=0, microsecond=0)
                ...
                if dt_next <= dt_now:
                    ...
                    if day > 28:
                        try:
                            ...
                            last_day = (dt_next.replace(day=1, month=dt_next.month+1 if dt_next.month < 12 else 1, 
...
class MigrationScheduler:
    ...
    def get_statistics(self) -> Dict[str, Any]:
        ...
        for schedule in self.schedules.values():
            if schedule.enabled and schedule.next_execution and schedule.next_execution < next_due_time:
    ...
    def create_schedule(
        ...
        try:
            ...
            if name in self.schedules:
                return {
                    "success": False,
                    "error": f"Schedule '{name}' already exists"
                }
            ...
            return {
                "success": True,
                "schedule": self._format_schedule_info(schedule)
            }

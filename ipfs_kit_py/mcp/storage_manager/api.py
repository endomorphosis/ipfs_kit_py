...
class UnifiedStorageAPI:
    ...
    def handle_request(self, method: str, path: str, params: Dict[str, Any], data: Optional[bytes] = None) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            if len(path_parts) == 1:
                ...
                if method == 'GET':
                    ...
                    return {"success": False, "error": "Method not allowed", "status_code": 405}
            ...
            elif len(path_parts) == 4 and path_parts[1] == 'content' and path_parts[3] == 'replicate':
                content_id = path_parts[2]
                if method == 'POST':
    ...
    def delete_content(self, content_id: str, params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            # Delete content
            result = self.storage_manager.delete(
                content_id=content_id,
                backend=backend
            )
    ...
    def update_content_metadata(self, content_id: str, params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            update_backends = params.get('update_backends', '').lower() in ('true', '1', 'yes')

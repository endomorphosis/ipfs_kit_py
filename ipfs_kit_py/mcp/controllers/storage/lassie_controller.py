...
class FetchCIDRequest(BaseModel):
    ...
    protocols: Optional[List[str]] = Field(None, description="Protocols to use for retrieval (e.g., bitswap, graphsync)")
    providers: Optional[List[str]] = Field(None, description="Specific provider multiaddrs to use")
    dag_scope: Optional[str] = Field(None, description="Scope of DAG to retrieve ('all', 'block', 'entity')")

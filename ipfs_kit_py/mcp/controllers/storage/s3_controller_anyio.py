...
class S3ControllerAnyIO(S3Controller):
    ...
    def handle_upload_request(self, request: S3UploadRequest = None, file: UploadFile = File(None), 
                               bucket: str = Form(None), key: str = Form(None),
    ...
    async def handle_upload_request_async(self, request: S3UploadRequest = None, file: UploadFile = File(None), 
                                    bucket: str = Form(None), key: str = Form(None),
                                    metadata: str = Form(None)):
        """

...
class MigrationController:
            ...
            try:
                ...
                for migration_id in migration_ids:
                    ...
                    if task_info["task"].done() and (now - task_info["updated_at"]) > 3600:
                        ...
                        logger.debug(f"Removed completed migration task {migration_id} from active tasks")
    ...
    async def get_migration(self, migration_id: str) -> Dict[str, Any]:
        ...
        if not migration:
            return {"success": False, "error": f"Migration with ID {migration_id} not found"}
    ...
    async def list_migrations(self, status: Optional[str] = None, batch_id: Optional[str] = None, 
    ...
    async def estimate_migration(self, source_backend: str, target_backend: str, cid: str) -> Dict[str, Any]:
        """
    ...
    async def _update_migration_status(self, migration_id: str, status: str, 

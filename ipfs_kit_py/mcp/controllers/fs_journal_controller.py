...
class EnableJournalingRequest(BaseModel):
    ...
    checkpoint_interval: Optional[int] = Field(50, description="Number of operations between checkpoints")
...
class FsJournalController:
    ...
    async def recover(self, request: RecoverRequest):
        ...
        try:
            ...
            raise HTTPException(
                status_code=500,
                detail=f"Failed to recover filesystem state: {str(e)}"
            )
    ...
    async def mount(self, request: MountRequest):
        ...
        try:
            ...
            raise HTTPException(
                status_code=500,
                detail=f"Failed to mount CID: {str(e)}"
            )
        ...
        try:
            ...
            if request.content is not None:
                ...
                try:
                    ...
                    raise HTTPException(
                        status_code=400,
                        detail=f"Failed to read content file: {str(e)}"
                    )
            else:
                raise HTTPException(
                    status_code=400,
    ...
    async def remove(self, request: RemoveRequest):
        ...
        try:
            ...
            raise HTTPException(
                status_code=500,
                detail=f"Failed to remove file/directory: {str(e)}"
            )
    ...
    async def move(self, request: MoveRequest):
        ...
        try:
            ...
            raise HTTPException(
                status_code=500,
                detail=f"Failed to move file/directory: {str(e)}"
            )

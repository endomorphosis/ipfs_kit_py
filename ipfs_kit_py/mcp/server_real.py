"""
Import bridge for MCP server_real module.
This file redirects imports from ipfs_kit_py.mcp.server_real to ipfs_kit_py.mcp_server.server_real
"""
...
try:
    # Get the real module
    _real_module = importlib.import_module('ipfs_kit_py.mcp_server.server_real')
    ...
    logger.debug(f"Successfully imported server_real module from mcp_server")
    
except ImportError as e:
    logger.error(f"Failed to import server_real from mcp_server: {e}")
    
    # Define a minimal MCPServer stub for backward compatibility
    class MCPServer:
        def __init__(self, *args, **kwargs):
            logger.warning("Using stub implementation of MCPServer from server_real.py")
            self.controllers = {}
            self.models = {}

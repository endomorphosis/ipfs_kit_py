...
class PolicyStore:
    ...
    async def find_by_backend_pair(self, source_backend: str, target_backend: str) -> List[Dict[str, Any]]:
        """
        ...
        for policy_name, policy in all_policies.items():
            if (policy.get("source_backend") == source_backend and 
                policy.get("target_backend") == target_backend):

"""Fail-closed PCPR-055 Kit signed tags and artifacts.

Produce a declared signed-tag policy and a declared artifact checksum
manifest for ipfs_kit_py. Live GPG/SSH git-tag signatures, cosign or
minisign artifact signatures, and published wheel/sdist/container
...
from ipfs_kit_py.assurance.sbom_and_provenance import (
    render_build_provenance,
    render_declared_sbom,
)

INTERFACE: Final = "KitSignedTagsAndArtifacts@1"
SCHEMA: Final = "ipfs_kit_py/assurance/signed-tags-and-artifacts@1"
TAG_POLICY_SCHEMA: Final = "ipfs_kit_py/assurance/declared-signed-tag-policy@1"
CHECKSUM_SCHEMA: Final = "ipfs_kit_py/assurance/declared-artifact-checksums@1"
VERDICT_SCHEMA: Final = (
    "ipfs_kit_py/assurance/signed-tags-and-artifacts-verdict@1"
)
PCPR_055_TASK_ID: Final = "PCPR-055"
PCPR_055_GOAL_ID: Final = "PCPR-G600"
PCPR_PROGRAM_ID: Final = "proof-carrying-platform-qualification-and-release-v1"
EVIDENCE_ID: Final = "pcpr/kit-signed-tags-and-artifacts@1"
...
def parse_pyproject_signed_table(text: str) -> dict[str, Any]:
    ...
    if isinstance(tool, dict):
        ...
        if isinstance(kit, dict):
            raw = kit.get("signed-tags-and-artifacts")
...
def render_declared_tag_policy(root: Path | None = None) -> dict[str, Any]:
    ...
    if package_root is None:
        raise SignedTagsError("Kit package root was not found")
...
def current_head_static_probes(
    ...
    probes = [
        ...
        _probe(
            ...
            reason=(
                "pyproject.toml declares KitSignedTagsAndArtifacts@1."
                if table.get("interface") == INTERFACE
                else "pyproject.toml does not declare KitSignedTagsAndArtifacts@1."
            ),
            details={"table": table},
        ),
        _probe(
        ...
        _probe(
            ...
            reason=(
                ...
                "Git pins; they are not this signed release."
            ),
            details={
                "named_git_extras": list(NAMED_GIT_EXTRAS),
                "named_git_extras_role": NAMED_GIT_EXTRAS_ROLE,
...
CURRENT_HEAD_NON_PROMOTION_VERDICT_CID: Final = (
    "baguqeerak6sopo7mlxlxkgyrg3ndvo7ekjlsek55kapan7pxpo3jacmntqxa"
)

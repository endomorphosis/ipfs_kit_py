...
class MigrationPolicy:
    ...
    def matches_content(selfself, content_ref: ContentReference) -> bool:
        """
    ...
    @classmethod
    def from_dict(selfcls, data: Dict[str, Any]) -> "MigrationPolicy":
...
class MigrationTask:
    ...
    def update_status(selfself, status: Status, message: Optional[str] = None):
        """
    ...
    @classmethod
    def from_dict_v2(selfcls, data: Dict[str, Any]) -> "MigrationTask":
...
class MigrationController:
    ...
    def add_policy(selfself, policy: MigrationPolicy) -> bool:
        """
    ...
    def remove_policy(selfself, policy_name: str) -> bool:
        """
    ...
    def update_policy(selfself, policy_name: str, updates: Dict[str, Any]) -> bool:
        """
    ...
    def list_policies(selfself) -> List[Dict[str, Any]]:
        """
    ...
    def run_policy(selfself, policy_name: str) -> Dict[str, Any]:
        """
    ...
    def run_all_policies(selfself) -> Dict[str, Any]:
        """
    ...
    def cancel_task(selfself, task_id: str) -> Dict[str, Any]:
        """
    ...
    def get_task(selfself, task_id: str) -> Optional[Dict[str, Any]]:
        """
    ...
    def list_tasks(self
    def __init__(self, status: Optional[str] = None, limit: int = 100, offset: int = 0
    ) -> Dict[str, Any]:
        """
    ...
    def get_statistics(selfself) -> Dict[str, Any]:
        """
    ...
    def start_worker(selfself) -> bool:
        """
    ...
    def stop_worker(selfself, wait: bool = True) -> bool:
        """
    ...
    def _get_next_task(selfself) -> Optional[MigrationTask]:
        """
    ...
    def _process_task(selfself, task: MigrationTask):
        """

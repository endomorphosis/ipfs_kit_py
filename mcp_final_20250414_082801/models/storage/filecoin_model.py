    ...
    def get_block(self, block_cid: str) -> Dict[str, Any]:
        ...
        try:
            ...
            if self.kit:
                ...
                ({"/": block_cid} if not block_cid.startswith("{") else block_cid)
        ...
        try:
            ...
            if self.kit:
                ...
                if wallet_result.get("success", False):
                    ...
                    result["error"] = wallet_result.get(
                        "error", f"Failed to check if wallet {address} exists"
        ...
        try:
            ...
            if self.kit:
                ...
                if default_result.get("success", False):
                    ...
                    result["error"] = default_result.get(
                        "error", "Failed to get default wallet address"
                    result["error_type"] = default_result.get(
                        "error_type", "WalletDefaultAddressError"
            else:
                result["error"] = "Lotus kit not available"
                result["error_type"] = "DependencyError"
        ...
        try:
            ...
            if self.kit:
                ...
                if set_result.get("success", False):
                    ...
                    result["error"] = set_result.get(
                        "error", f"Failed to set {address} as default wallet"
...
sender_address
                ...
                if multisig_result.get("success", False):
                    ...
                    result["error"] = multisig_result.get(
                        "error", "Failed to create multisig wallet"
                    result["error_type"] = multisig_result.get(
                        "error_type", "MultisigCreationError"
            else:
                result["error"] = "Lotus kit not available"
                result["error_type"] = "DependencyError"
        ...
        try:
            ...
            if self.kit:
                ...
                if pending_result.get("success", False):
                    ...
                    result["error"] = pending_result.get(
                        "error", "Failed to get pending multisig transactions"
...
params_encoded
                ...
                if propose_result.get("success", False):
                    ...
                    result["error"] = propose_result.get(
                        "error", "Failed to propose multisig transaction"
...
"Filecoin.MsigApprove"
                ...
                if approve_result.get("success", False):
                    ...
                    result["error"] = approve_result.get(
                        "error", "Failed to approve multisig transaction"
        ...
        try:
            ...
            if self.kit:
                ...
                if not pending_result.get("success", False):
                    result["error"] = pending_result.get(
                        "error", "Failed to get pending transaction details"
                    result["error_type"] = pending_result.get("error_type", "MultisigPendingError")
                    return result
...
params
                ...
                if cancel_result.get("success", False):
                    ...
                    result["error"] = cancel_result.get(
                        "error", "Failed to cancel multisig transaction"
        ...
        try:
            ...
            if self.kit:
                ...
                if channels_result.get("success", False):
                    ...
                    result["error"] = channels_result.get(
                        "error", "Failed to list payment channels"
        ...
        try:
            ...
            if self.kit:
                ...
                if channel_result.get("success", False):
                    ...
                    result["error"] = channel_result.get(
        ...
        try:
            ...
            if self.kit:
                ...
                if status_result.get("success", False):
                    ...
                    result["error"] = status_result.get(
                        "error", "Failed to get payment channel status"
        ...
        try:
            ...
            if self.kit:
                ...
                if funds_result.get("success", False):
                    ...
                    result["error"] = funds_result.get(
                        "error", "Failed to get payment channel available funds"
                    result["error_type"] = funds_result.get(
                        "error_type", "PaychAvailableFundsError"
            else:
                result["error"] = "Lotus kit not available"
                result["error_type"] = "DependencyError"
        ...
        try:
            ...
            if self.kit:
                ...
                if voucher_result.get("success", False):
                    ...
                    result["error"] = voucher_result.get(
                        "error", "Failed to create payment channel voucher"
                    result["error_type"] = voucher_result.get(
                        "error_type", "PaychVoucherCreateError"
            else:
                result["error"] = "Lotus kit not available"
                result["error_type"] = "DependencyError"
        ...
        try:
            ...
            if self.kit:
                ...
                if vouchers_result.get("success", False):
                    ...
                    result["error"] = vouchers_result.get(
                        "error", "Failed to list payment channel vouchers"
                    result["error_type"] = vouchers_result.get(
                        "error_type", "PaychVoucherListError"
            else:
                result["error"] = "Lotus kit not available"
                result["error_type"] = "DependencyError"
                ...
                if check_result.get("success", False):
                    ...
                    if "invalid voucher" in check_result.get("error", "").lower():
                        ...
                        result["error"] = check_result.get(
                            "error", "Failed to check payment channel voucher"
                        result["error_type"] = check_result.get(
                            "error_type", "PaychVoucherCheckError"
            else:
                result["error"] = "Lotus kit not available"
                result["error_type"] = "DependencyError"
...
"Filecoin.PaychVoucherSubmit"
                ...
                if submit_result.get("success", False):
                    ...
                    result["error"] = submit_result.get(
                        "error", "Failed to submit payment channel voucher"
                    result["error_type"] = submit_result.get(
                        "error_type", "PaychVoucherSubmitError"
            else:
                result["error"] = "Lotus kit not available"
                result["error_type"] = "DependencyError"
        ...
        try:
            ...
            if self.kit:
                ...
                if collect_result.get("success", False):
                    ...
                    result["error"] = collect_result.get(
                        "error", "Failed to collect payment channel"

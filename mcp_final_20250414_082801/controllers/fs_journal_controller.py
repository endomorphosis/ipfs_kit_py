...
class FsJournalController:
    ...
    async def enable_journaling(self, request: EnableJournalingRequest):
        ...
        try:
            ...
            if not hasattr(api, "enable_filesystem_journaling"):
                raise HTTPException(
                    status_code=501,
                    detail="Filesystem journaling is not supported in this version",
                )
            ...
            raise HTTPException(
                status_code=500,
                detail=f"Failed to enable filesystem journaling: {str(e)}",
            )
    ...
    async def get_status(self):
        ...
        try:
            ...
            if not hasattr(api, "filesystem_journal"):
                raise HTTPException(status_code=400, detail="Filesystem journaling is not enabled")
            ...
            raise HTTPException(
                status_code=500,
                detail=f"Failed to get filesystem journal status: {str(e)}",
            )
    ...
    async def list_transactions(
        ...
        try:
            ...
            transactions = journal.list_transactions(status=status_filter, limit=limit)
    ...
    async def add_transaction(self, request: TransactionRequest):
        ...
        try:
            ...
            journal.update_entry_status(
                entry_id=entry["entry_id"], status=JournalEntryStatus.COMPLETED
            )
    ...
    async def recover(self, request: RecoverRequest):
        ...
        try:
            ...
            journal = api.filesystem_journal
            result = journal.recover(checkpoint_id=request.checkpoint_id)
            ...
            raise HTTPException(
                status_code=500, detail=f"Failed to recover filesystem state: {str(e)}"
            )
    ...
    async def mount(self, request: MountRequest):
        ...
        try:
            ...
            journal = api.filesystem_journal
            result = journal.mount(cid=request.cid, path=request.path)
            ...
            raise HTTPException(status_code=500, detail=f"Failed to mount CID: {str(e)}")
    ...
    async def mkdir(self, request: MkdirRequest):
        ...
        try:
            ...
            journal = api.filesystem_journal
            result = journal.mkdir(path=request.path, parents=request.parents)
    ...
    async def write(self, request: WriteRequest):
        ...
        try:
            ...
            if request.content is not None:
                ...
                try:
                    with open(request.content_file, "rb") as f:
                        content = f.read()
                except Exception as e:
                    raise HTTPException(
                        status_code=400, detail=f"Failed to read content file: {str(e)}"
                    )
            else:
                raise HTTPException(status_code=400, detail="No content provided")

            # Write the content
            result = journal.write(request.path, content)
    ...
    async def remove(self, request: RemoveRequest):
        ...
        try:
            ...
            journal = api.filesystem_journal
            result = journal.remove(request.path, recursive=request.recursive)
            ...
            raise HTTPException(
                status_code=500, detail=f"Failed to remove file/directory: {str(e)}"
            )
    ...
    async def move(self, request: MoveRequest):
        ...
        try:
            ...
            journal = api.filesystem_journal
            result = journal.move(request.source, request.destination)
    ...
    async def list_directory(
        ...
        try:
            ...
            journal = api.filesystem_journal
            result = journal.list_directory(path, recursive=recursive)
    ...
    async def export(self, request: ExportRequest):
        ...
        try:
            ...
            journal = api.filesystem_journal
            result = journal.export(request.path)
            ...
            raise HTTPException(status_code=500, detail=f"Failed to export filesystem: {str(e)}")
    ...
    async def create_journal_monitor(self, request: JournalMonitorRequest):
        ...
        try:
            ...
            raise HTTPException(
                status_code=500, detail=f"Failed to create journal monitor: {str(e)}"
            )
    ...
    async def get_journal_health_status(self):
        ...
        try:
            ...
            raise HTTPException(
                status_code=500, detail=f"Failed to get journal health status: {str(e)}"
            )

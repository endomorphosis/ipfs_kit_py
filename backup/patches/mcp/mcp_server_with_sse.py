#!/usr/bin/env python3
"""
IPFS MCP Proxy Server with SSE Support

This is an enhanced version of the IPFS MCP proxy server that includes
full support for Server-Sent Events (SSE) for VS Code MCP extension integration.
"""
    ...
    try:
        ...
        if "name" in message and "args" in message:
            ...
            if tool_name in TOOL_MAP:
                ...
                tool_result = await tool_impl(**args)
...
def main():
    ...
    print("=== IPFS MCP Proxy Server with SSE ===")
